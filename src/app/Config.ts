...
export const defaultAircraftConfig: AircraftConfig = {
  ...
  autopilot: {
    engageAirspeed: 24,
    engageAltitude: 2,
    defaultClimbPitchRad: degToRad(6),
    minPitchRad: degToRad(-4),
    maxPitchRad: degToRad(11),
    maxRollRad: degToRad(28),
    pitchAdjustRateRadPerSec: degToRad(2.8),
    rollAdjustRateRadPerSec: degToRad(24),
    rollReturnRateRadPerSec: degToRad(10),
    pitchKp: 2.2,
    pitchKd: 0.45,
    rollKp: 1.8,
    rollKd: 0.9,
    maxPitchCommand: 0.42,
    maxRollCommand: 0.65,
  },
  ground: {
    wheelRadius: 0.36,
